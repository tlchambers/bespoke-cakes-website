...
function Footer() {
	return (
		<div className="w-full mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 bg-[#f8f8f8]">
			<div>
				<h1 className="text-3xl">Beautifully Baked By Ess</h1>
				<p className="py-4">
					Step into the world of Beautifully Baked By Ess, where every cake,
					cupcake, and treat is lovingly handmade in Brockley, South East
					London. Our bespoke creations are not only visually stunning, but also
					bursting with flavor, ensuring that every bite is as unforgettable as
					the occasion itself.
				</p>
			</div>
